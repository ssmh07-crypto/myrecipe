  ...
  return (
    <Suspense fallback={<PageFallback />}>
      <Routes>
        ...
        <Route path="/recipes/search" element={<AppLayout requireAuth={false}><RecipeListPage title="레시피 검색" subtitle="저장한 레시피를 이름과 메모로 찾아보세요." showImportAction={false} autoFocusSearch /></AppLayout>} />
